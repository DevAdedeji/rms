...
const { updateExamOfficer, updated, updating } = useUpdateExamOfficer();

const props = defineProps<{
  examOfficer: User | null;
}>();
...
watch(
  () => props.examOfficer,
  () => {
    if (props.examOfficer) {
      form.value.faculty = props.examOfficer.faculty;
      form.value.first_name = props.examOfficer.first_name;
      form.value.last_name = props.examOfficer.last_name;
      form.value.department = props.examOfficer.department;
      form.value.id = props.examOfficer.id;
    }
  },
  { immediate: true },
);
