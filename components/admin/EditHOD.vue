...
const { updateHOD, updated, updating } = useUpdateHOD();
...
watch(
  () => props.headofDepartment,
  () => {
    if (props.headofDepartment) {
      form.value.faculty = props.headofDepartment.faculty;
      form.value.first_name = props.headofDepartment.first_name;
      form.value.last_name = props.headofDepartment.last_name;
      form.value.department = props.headofDepartment.department;
      form.value.id = props.headofDepartment.id;
    }
  },
  { immediate: true },
);
